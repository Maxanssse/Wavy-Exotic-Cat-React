        ...
        <div className="pricing14-section-title">
          ...
          <div className="pricing14-content">
            <h2>
              {props.heading1 ?? (
                <Fragment>
                  <h2 className="pricing14-text065 thq-heading-2">
                    Pricing plan
                  </h2>
                </Fragment>
              )}
              ...
              <div className="pricing14-price">
                <div className="pricing14-price01">
                  ...
                  <h3>
                    {props.plan1Price ?? (
                      <Fragment>
                        <h3 className="pricing14-text080 thq-heading-3">$20</h3>
                      </Fragment>
                    )}
                  </h3>
                  <p>
                    {props.plan1Yearly ?? (
                      <Fragment>
                        <p className="pricing14-text106 thq-body-large">$200</p>
                      </Fragment>
                    )}
                  </p>
                </div>
              ...
              <div className="pricing14-price02">
                <div className="pricing14-price03">
                  ...
                  <h3>
                    {props.plan2Price ?? (
                      <Fragment>
                        <h3 className="pricing14-text064 thq-heading-3">$40</h3>
                      </Fragment>
                    )}
                  </h3>
                  <p>
                    {props.plan2Yearly ?? (
                      <Fragment>
                        <p className="pricing14-text069 thq-body-large">$400</p>
                      </Fragment>
                    )}
                  </p>
                </div>
              ...
              <div className="pricing14-price04">
                <div className="pricing14-price05">
                  ...
                  <h3>
                    {props.plan3Price ?? (
                      <Fragment>
                        <h3 className="pricing14-text098 thq-heading-3">$60</h3>
                      </Fragment>
                    )}
                  </h3>
                  <p>
                    {props.plan3Yearly ?? (
                      <Fragment>
                        <p className="pricing14-text088 thq-body-large">$600</p>
                      </Fragment>
                    )}
                  </p>
                </div>
              ...
              <div className="pricing14-price06">
                <div className="pricing14-price07">
                  ...
                  <h3>
                    {props.plan1Price1 ?? (
                      <Fragment>
                        <h3 className="pricing14-text087 thq-heading-3">
                          $200/yr
                        </h3>
                      </Fragment>
                    )}
              ...
              <div className="pricing14-price08">
                <div className="pricing14-price09">
                  ...
                  <h3>
                    {props.plan2Price1 ?? (
                      <Fragment>
                        <h3 className="pricing14-text097 thq-heading-3">
                          $299/yr
                        </h3>
                      </Fragment>
                    )}
                  ...
                  <span>
                    {props.plan2Yearly1 ?? (
                      <Fragment>
                        <span className="pricing14-text089 thq-body-large">
                          or $29 monthly
                        </span>
                      </Fragment>
                    )}
              ...
              <div className="pricing14-price10">
                <div className="pricing14-price11">
                  ...
                  <h3>
                    {props.plan3Price1 ?? (
                      <Fragment>
                        <h3 className="pricing14-text084 thq-heading-3">
                          $499/yr
                        </h3>
                      </Fragment>
                    )}
